        ...
        <div class="pb-12">
            <div class="max-w-12xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-12 relative">
                    ...
                    <div class="col-span-12 p-2 bg-white overflow-hidden shadow-xl sm:rounded-lg ">
                        <div class="p-2 mb-2">
                            <label for="feedback_name" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Feedback Name</label>
                            <input type="text" v-model="feedback_name" placeholder="Nhập tên khách hàng" class="bg-gray-50 border text-base border-gray-300 text-gray-900  rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-purple-500 dark:focus:border-purple-500" required>
                            <span class="text-red-600 text-xs" ref="scroll_feedback_name">{{ error.feedback_name }}</span>

                        </div>
                        <div class=" p-2 mb-2">
                            <label for="feedback_content" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Nội Dung Feedback</label>
                            <textarea v-model="feedback_content" rows="5" placeholder="Nhập nội dung feedback" class="bg-gray-50 border text-base border-gray-300 text-gray-900  rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-purple-500 dark:focus:border-purple-500">
                            </textarea>
                            <span class="text-red-600 text-xs" ref="scroll_feedback_content">{{ error.feedback_content }}</span>
...
export default {
    ...
    methods: {
        clearErrors() {
            ...
            this.error.feedback_name = "";
            this.error.feedback_content = "";
        },
        ...
        submitForm() {
            ...
            const feedback_name = this.feedback_name;
            const feedback_content = this.feedback_content;
    ...
    setup() {
        ...
        feedback_name.value = data.props.data.feedback_name;
        feedback_content.value = data.props.data.feedback_content;
