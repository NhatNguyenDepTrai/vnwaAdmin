                    ...
                    <div class="col-span-6 p-2">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3 mb-3 p">
                            <div class="mb-3">
                                ...
                                <label for="name" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Danh mục</label>
                            ...
                            <div class="mb-3">
                                ...
                                <SelectMutiple :options="dataBlogTag" ref="tags" />
...
export default {
    ...
    setup() {
        ...
        console.log('dataBlogTag.value');
        console.log(dataBlogTag.value);
        console.log('dataBlogTag.value');
        console.log(dataCategoryBlog.value);
        return {
            dataCategoryBlog, dataBlogTag
        }
    },
