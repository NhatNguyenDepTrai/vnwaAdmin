                ...
                <div class="grid grid-cols-12 relative">
                    ...
                    <div class="col-span-9 p-2">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3 mb-3 p">
                            ...
                            <div class="mb-3">
                                <label for="link" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Link</label>
...
import getlink from 'speakingurl';
...
export default {
            ...
            axios.post('', {
                ...
                .then((response) => {
                    if (response.data.error) {
                        ...
                        this.$inertia.visit(route('Brand'));
                    }
                })
                .catch((error) => {
                    console.log(error);
    ...
    setup() {
        ...
        link.value = data.props.data.link;
