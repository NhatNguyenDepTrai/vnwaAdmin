    ...
    <AppLayout title="Thêm Đối Tác">
        ...
        <div class="overflow-hidden  px-5 mb-3 ">
            <div class="w-100  p-1 flex justify-between items-center">
                <div class="  ">
                    <Link :href="route('Brand')" class="text-dark-700 hover:text-purple-900 font-bold underline decoration-1">
                    ...
                    <div class="col-span-9 p-2">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3 mb-3 p">
                            <div class="mb-3">
                                ...
                                <input type="text" v-model="name" placeholder="vd: Vinawebapp Company" id="name" class="bg-gray-50 border text-base border-gray-300 text-gray-900  rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-purple-500 dark:focus:border-purple-500" required>
                                <span class="text-red-600 text-xs" ref="scroll_name">{{ error.name }}</span>
                            </div>
                            <div class="mb-3">
                                <label for="name" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Link Dữ Liệu</label>
                                <input type="text" v-model="link" placeholder="vd: http://vinawebapp.com/" class="bg-gray-50 border text-base border-gray-300 text-gray-900  rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-purple-500 dark:focus:border-purple-500" required>
                                <span class="text-red-600 text-xs" ref="scroll_link">{{ error.link }}</span>
                            </div>
                            <div class="mb-3">
...
export default {
    ...
    components: {
        InputUrlImage, ButtonMutipleImage, Editer, AppLayout
    },
