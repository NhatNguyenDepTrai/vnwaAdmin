                ...
                <div class="grid grid-cols-12 relative">
                    ...
                    <div class="col-span-6 p-2">
                        <div class="mb-3">
                            ...
                            <label for="name" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Danh mục Bài Viết</label>
                            <select v-model="id_category_blog" class="bg-gray-50 border text-base border-gray-300 text-gray-900  rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-purple-500 dark:focus:border-purple-500">
                                <option value="">Chọn danh mục Bài Viết</option>
                                <option v-for="item in dataCategoryBlog" :value="item.id">{{ item.name }}</option>

                            </select>
                            <span class="text-red-600 text-xs" ref="scroll_id_category_blog">{{ error.id_category_blog }}</span>
                        </div>
                        <div class="mb-3">

                            <label for="name" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Tag</label>
                            <SelectMutiple :options="dataBlogTag" :selected="dataBlogTagSelected" ref="tags" />
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            this.clearErrors();
            const id_category_blog = this.id_category_blog;
            const tags = this.$refs.tags.dataSelectedOptions;
    ...
    setup() {
        ...
        const dataCategoryBlog = ref([]);
        dataCategoryBlog.value = data.props.dataCategoryBlog;

        const id_category_blog = data.props.data.id_category_blog;
        const dataBlogTagSelected = ref([]);
        dataBlogTagSelected.value = data.props.dataBlogTagSelected;
        const dataBlogTag = ref([]);
        dataBlogTag.value = data.props.dataBlogTag;
        return {
